      ...
      <ha-card tabindex="0" aria-label=${"HomeTheater: "+this._config.entity}>
          ...
          <div class="home-theater-footer">
            ...
            <div class="control-wrapper">
              ...
              <div class="source-wrapper">
                ${"on"!==t.state?"":t.attributes.source_list.map(e=>{const i=this._config.sources.find(t=>t.source===e);return i?!1!==i.visible?i.icon?H`
                              <mwc-icon-button
                                .label=${i.name||e}
        ...
        <div class="volume-controls">
          ${e?H`
              ...
              `:""}
          <mwc-icon-button .onclick=${this.toggleMuteAVR} disabled=${"on"!==t.state}>
            <ha-icon
